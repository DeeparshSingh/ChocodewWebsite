...
export default function ContactPage() {
  return (
    <div className="w-full min-h-screen bg-background text-foreground">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 pb-12 md:pt-32 md:pb-16 lg:pt-40 lg:pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 mt-8 md:mt-12">
          <ContactInfo />
          <ContactForm />
        </div>
