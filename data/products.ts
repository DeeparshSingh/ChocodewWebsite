...
export const products: Product[] = [
  {
    ...
    category: "machines",
    image: "https://images.pexels.com/photos/2608497/pexels-photo-2608497.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    slug: "barista-pro-x1",
    category: "machines",
    image: "https://images.pexels.com/photos/585753/pexels-photo-585753.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    category: "machines",
    image: "https://images.pexels.com/photos/6207297/pexels-photo-6207297.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    category: "premixes",
    image: "https://images.pexels.com/photos/6941024/pexels-photo-6941024.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    category: "premixes",
    image: "https://images.pexels.com/photos/5946646/pexels-photo-5946646.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    category: "premixes",
    image: "https://images.pexels.com/photos/7525029/pexels-photo-7525029.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    category: "premixes",
    image: "https://images.pexels.com/photos/5825604/pexels-photo-5825604.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    category: "dispensers",
    image: "https://images.pexels.com/photos/4000600/pexels-photo-4000600.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    category: "dispensers",
    image: "https://images.pexels.com/photos/8478097/pexels-photo-8478097.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  {
    id: "ch-001",
    name: "Premium Hot Chocolate Sachets",
    slug: "premium-hot-chocolate-sachets",
    category: "chocolates",
    image: "https://images.pexels.com/photos/7061388/pexels-photo-7061388.jpeg?auto=compress&cs=tinysrgb&w=800",
    shortDescription: "Individual sachets of gourmet hot chocolate mix.",
    description: "Our Premium Hot Chocolate Sachets offer the perfect single-serving of luxurious hot chocolate. Each sachet contains our signature blend of fine cocoa and premium ingredients for a rich, satisfying beverage.",
    featured: false,
    specs: [
      { name: "Weight", value: "25g per sachet" },
      { name: "Packaging", value: "Box of 50 sachets" },
      { name: "Ingredients", value: "Cocoa, milk solids, sugar" },
      { name: "Shelf Life", value: "12 months" },
      { name: "Storage", value: "Cool, dry place" },
      { name: "Preparation", value: "Add hot water" },
    ],
    features: [
  ...
  {
    id: "ch-002",
    name: "Chocolate Coated Coffee Beans",
    slug: "chocolate-coated-coffee-beans",
    category: "chocolates",
    image: "https://images.pexels.com/photos/7810756/pexels-photo-7810756.jpeg?auto=compress&cs=tinysrgb&w=800",
    shortDescription: "Premium coffee beans coated in rich dark chocolate.",
    description: "Our Chocolate Coated Coffee Beans combine the rich flavor of dark chocolate with the intense taste of premium coffee beans. The perfect treat for coffee lovers, offering a delightful combination of crunch, bitterness, and sweetness.",
    featured: false,
    specs: [
      { name: "Weight", value: "250g jar" },
      { name: "Ingredients", value: "Coffee beans, dark chocolate" },
      { name: "Cocoa Content", value: "70%" },
      { name: "Shelf Life", value: "6 months" },
      { name: "Storage", value: "Cool, dry place" },
      { name: "Origin", value: "Arabica beans" },
    ],
    features: [
